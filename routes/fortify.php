...
Route::group(['middleware' => config('fortify.middleware', ['web'])], function () {
    ...
    if ($enableViews) {
        Route::get(
            ...
            [\App\Http\Controllers\AuthenticatedSessionController::class, 'create']
        )
    ...
    Route::get(
        RoutePath::for('auth.webex', '/auth/webex'),
        [\App\Http\Controllers\AuthenticatedSessionController::class, 'webexOauthRedirect']
    )
        ->middleware(['guest:'.config('fortify.guard')])
        ->name('auth.webex');

    Route::get(
        RoutePath::for('auth.webex.callback', config('services.webex.redirect')),
        [\App\Http\Controllers\AuthenticatedSessionController::class, 'webexOauthCallback']
    )
    ...
    Route::post(
        ...
        [\App\Http\Controllers\AuthenticatedSessionController::class, 'destroy']
    )
        ->name('logout');
